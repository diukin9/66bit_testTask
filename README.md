...
Реализован функционал простейшего Web-приложения «Каталог футболистов 3.0».
Стек технологий: C#, ASP NET Core 5, PostgreSQL. Приложение состоит из двух страниц с переключателем между ними.
